...
// InheritanceSrc.MainMachine 'HAS-A' String
class MainMachine {
    String model;
...
// InheritanceSrc.Developer 'HAS-A' InheritanceSrc.MainMachine
// InheritanceSrc.Developer 클래스는 MainMachine의 객체 하나를 보유한다.
class Developer2 {
    String name;
    MainMachine mainMachine;

    public Developer2(String name, MainMachine machine) {
        this.name = name;
...
public class ClassComposition {
    public static void main(String[] args) {
        ...
        Developer2 dev = new Developer2("너개발", mac);
